...
const sections = [
  {
    title: { en: "What this app is", mn: "Энэ апп юу вэ" },
  ...
  {
    title: { en: "Daily flow (recommended)", mn: "Өдөр тутмын урсгал" },
  ...
  {
    title: { en: "Spaced repetition (review queue)", mn: "Spaced repetition" },
  ...
  {
    title: { en: "Quiz modes", mn: "Шалгалтын горимууд" },
  ...
  {
    title: { en: "Quiz availability", mn: "Шалгалт хэзээд нээлттэй" },
  ...
  {
    title: { en: "Stats and mastery", mn: "Статистик ба mastery" },
  ...
  {
    title: { en: "Tips to get the best results", mn: "Хамгийн сайн үр дүнгийн зөвлөмж" },
...
export default function GuidePage() {
  ...
  const copy =
    language === "mn"
      ? {
          title: "Vocaura-г хэрхэн ашиглах вэ",
          subtitle: "Апп хэрхэн ажилладаг, өдөр тутмын урсгал ямар байх, шалгалт ба давтлага яаж явдгийг ойлгомжтой тайлбарлав.",
        }
      : {
          title: "How to use Vocaura",
          subtitle: "A clear walkthrough of how the app works, the daily routine, and how quizzes and reviews behave.",
        };
        ...
        {sections.map((section, idx) => {
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-display text-xl">{section.title[language]}</h2>
            </div>
            <p className="text-sm text-text">{section[language]}</p>
          </motion.div>
        )})}
      </div>
    </div>
